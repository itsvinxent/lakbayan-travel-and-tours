    ...
    <section class="sections admin-usr" id="admin-usr" style="margin-top: 5rem;">
        ...
        <div class="profile-view-container">
            <div class="nav-vertical">
                ...
                <ul class="tabs">
                    <li data-tab-target=".content-users" class="tab active">
                    ...
                    <li data-tab-target=".content-users" class="tab">
            ...
            <div class="main-panel" style="position: relative; width: 100%;">
                <div class="tab-content" id="tab-content">
                    ...
                    <div data-tab-content class="data-tab-content content-verification">
