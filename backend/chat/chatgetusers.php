...
$pass = true;
$output = "";
$sql = mysqli_query($conn, "SELECT US.*, COUNT(MS.message_id) AS `Number` FROM user_tbl AS US INNER JOIN message_tbl AS MS ON (US.id = MS.messageFrom_id OR US.id = MS.messageTo_id)
