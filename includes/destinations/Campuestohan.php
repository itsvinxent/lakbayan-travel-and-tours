  ...
  <body>
    ...
    <section class="destination-pages">
      ...
      <div class="header">
        ...
        <h1 class="loc">Campuestohan High Land Resort</h1>
        ...
        <div class="right">
            ...
            <div class="slider">
                <div class="slides">
                    ...
                    <div class="slide">
                        <img src="../../assets/img/Campuestohan3.jpeg" alt="">
                    </div>
            ...
            <div class="paragraph">
              <p>Campuestohan Highland Resort, a new tourist destination in Negros Occidental province, opened its doors. Campuestohan Highland Resort is a family-friendly amusement park resort in Talisay City's Barangay Cabatangan. Campuestohan occupies an area of 5.5 hectares and features a variety of recreational activities, as well as a restaurant and a number of lodging options for visitors who wish to spend the night.

                Visitors to Campuestohan will enjoy cooler temperatures and an incredible view of the Negros Occidental plains and the Guimaras Strait in the background thanks to its elevation of 800++ meters above sea level (Tagaytay is at 600 meters).
                
                The two swimming pools at Campuestohan Highland Resort are open to both day visitors and overnight guests. Despite the fact that the resort is located in the mountains, the hot sun will entice you to cool off in the pool. Before going swimming, be sure to use sunblock.
              </p>
            </div>
