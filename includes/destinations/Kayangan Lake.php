    ...
    <section class="destination-pages">
      ...
      <div class="content">
        <div class="right">
            ...
            <div class="slider">
                <div class="slides">
                    ...
                    <div class="slide first">
                        <img src="../../assets/img/Kayangan1.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="../../assets/img/Kayangan2.jpg" alt="">
                    </div>
                    <div class="slide">
                        <img src="../../assets/img/Kayangan3.jpg" alt="">
                    </div>
            ...
            <div class="paragraph">
              <p>It's no surprise that Kayangan Lake is the most popular location on Coron Island. It's an immaculate reef with crystal clear water that you arrive at when you arrive at the "parking lot". Kayangan Lake can be reached by clambering down the other side of the stairs after parking your boat at the end of the path. Located in Coron, Palawan, it is one of the most breathtaking spots in the area thanks to its crystal-clear waters and incredible underwater rock formations.

                At Kayangan Lake, the water is said to be the clearest in the country. Despite the fact that we haven't seen them all, it's clear that this lake is unique. The water is crystal-clear, and the hues are vibrant.
              </p>
            </div>
