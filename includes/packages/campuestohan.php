  ...
  <section class="packages-pages">
    ...
    <div class="content">
      <div class="right">
        ...
        <div class="reservation">
          <div class="contact">
            ...
            <a href="#" style="margin-left: 25px">Campuestohan Highland Resort</a>
            <div class="info">
      ...
      <div class="left">
        ...
        <br>
        Machines, ziplines, and sky bikes, among other amenities, are ideal for team-building events or simply having fun with friends. All of this, plus year-round invigorating highland weather. A restaurant that serves Filipino food.
        </p>
        <p>
          <br />
          Inclusions:<br />
          - Pickup of traveler around Talisay<br />
          - Entrance Fee<br />
          - Room Reservation<br />
          - Swimming Pool<br />
          - Unlimited Rides<br />
      ...
      <div class="card-container">
        ...
        <div class="card">
          ...
          <span><a href="ruins.php">
              <p class="dest">The Ruins Day Tour</p>
