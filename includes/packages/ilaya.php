    ...
    <div class="content">
      <div class="right">
        <div class="slider">
          <div class="slides">
            ...
            <div class="slide">
              <img src="../../assets/img/Ilaya2.jpg" alt="" />
            </div>
            <div class="slide">
              <img src="../../assets/img/Ilaya3.jpg" alt="" />
            </div>
        ...
        <div class="reservation">
          <div class="contact">
            ...
            <a href="#" style="margin-left: 25px">Bacolod Ilaya Resort</a>
            <div class="info">
            ...
            <?php if ($_SESSION['isLoggedIn'] == false) {
              ...
              echo "
                ...
                <p>Enter the following details and our team will contact you if the location is available on your chosen date.</p>
                  <input type=\"hidden\" name=\"loc\" value=\"ilaya\"/>
      ...
      <div class="left">
        ...
        <p>
          <br />
          Inclusions:<br />
          - Pickup/Dropoff along Silay City<br />
          - Parking<br />
