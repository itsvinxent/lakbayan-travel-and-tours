...
<body>
  ...
  <section class="packages-pages">
    ...
    <div class="content">
      <div class="right">
        <div class="slider">
          <div class="slides">
            ...
            <div class="slide">
              <img src="../../assets/img/Nabulao2.jpg" alt="" />
            </div>
            <div class="slide">
              <img src="../../assets/img/Nabulao3.jpg" alt="" />
            </div>
        ...
        <div class="reservation">
          <div class="contact">
            ...
            <a href="#" style="margin-left: 25px">Nabila Beach and Dive Resort, Sipalay</a>
            <div class="info">
            ...
            <?php if ($_SESSION['isLoggedIn'] == false) {
              ...
              echo "
                ...
                <p>Enter the following details and our team will contact you if the location is available on your chosen date.</p>
                  <input type=\"hidden\" name=\"loc\" value=\"nabulao\"/>
      ...
      <div class="left">
        <h1>Nabulao Beach and Dive Resort</h1>
        <h2>About:</h2>
