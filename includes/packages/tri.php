...
<body>
  ...
  <section class="packages-pages">
    ...
    <div class="content">
      <div class="right">
        <div class="slider">
          <div class="slides">
            ...
            <div class="slide first">
              <img src="../../assets/img/tri 2.jpg" alt="" />
            </div>
            <div class="slide">
              <img src="../../assets/img/tri 3.jpg" alt="" />
            </div>
            <div class="slide">
              <img src="../../assets/img/tri 4.jpg" alt="" />
            </div>
        ...
        <div class="reservation">
          <div class="contact">
            ...
            <a href="#" style="margin-left: 25px">The Ruins</a>
            <br /><a href="#" style="margin-left: 25px">Balay Negrense Museum</a>
            <div class="info">
            ...
            <?php if ($_SESSION['isLoggedIn'] == false) {
              ...
              echo "
                ...
                <p>Enter the following details and our team will contact you if the location is available on your chosen date.</p>
                  <input type=\"hidden\" name=\"loc\" value=\"tri-city\"/>
      ...
      <div class="left">
        <h1>Tri-City Bacolod Day Tour</h1>
        <h2>About:</h2>
        <p>
        ...
        <p>
          ...
          - Entry/Admission - The Ruins<br />
          - Entry/Admission - Balay Negrense Museum<br />
          - Entry/Admission - Campuestohan Highland Resort<br />
          - Entry/Admission - Pope John Paul II Tower<br />
        </p>
      </div>
    </div>
    ...
    <div class="recommendations">
      ...
      <div class="card-container">
        ...
        <div class="card">
          ...
          <span><a href="ruins.php">
              <p class="dest">The Ruins</p>
