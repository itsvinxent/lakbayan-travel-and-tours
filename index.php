...
<body>
  ...
  <section class="main-page vidban">
    <div id="bann" class="banner">
      <video src="http://da6gltgyhi54u.cloudfront.net/media/waves.mp4" muted loop autoplay preload="auto"></video>
  ...
  <section id="login" class="main-page login">
    <div class="login-banner">
      <video src="http://da6gltgyhi54u.cloudfront.net/media/Foggy.mp4" muted loop autoplay preload="auto"></video>
  ...
  <section class="main-page user-pref">
    <div class="login-banner">
      <video src="http://da6gltgyhi54u.cloudfront.net/media/plane.mp4" muted loop autoplay preload="auto"></video>
        ...
        <div class="page-one" id="page-one">
          ...
          <div class="checklist">
            ...
            <label class="choice" for="beaches">
              <img src="http://da6gltgyhi54u.cloudfront.net/img/beaches.jpg" alt="">
            ...
            <input type="checkbox" id="mountain" name="select-preferences" value="Mountains">
              ...
              <img src="http://da6gltgyhi54u.cloudfront.net/img/mountains.jpg" alt="">
            ...
            <input type="checkbox" id="island" name="select-preferences" value="Islands">
              ...
              <img src="http://da6gltgyhi54u.cloudfront.net/img/islands.jpg" alt="">
            ...
            <label class="choice" for="animal">
              <img src="http://da6gltgyhi54u.cloudfront.net/img/animals.jpg" alt="">
            ...
            <label class="choice" for="recreation">
              <img src="http://da6gltgyhi54u.cloudfront.net/img/recreation.jpg" alt="">
            ...
            <label class="choice" for="history">
              <img src="http://da6gltgyhi54u.cloudfront.net/img/history.jpeg" alt="">
